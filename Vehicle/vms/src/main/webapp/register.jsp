...
<div class="header_bg">
   <div class="container">
	<div class="header">
	  <div class="head-t">
		 <div class="logo">
			  <a href="#"><h1>Vehicle <span>Management</span></h1> </a>
		  </div>
		  <div class="header_right">
			<div class="cart box_1">
				<a href="#">
				<div>
				<a  href="#"><img src="images/logo.png" width="80px" height="80px" /></a></div>
				<div class="clearfix"> </div> 
			</div>			 
		</div>
		<div class="clearfix"></div>	
...
<!--products-->
	<div class="products">
<form action="/vms/Register" method="post">
  <h1>Sign Up</h1>  
  <fieldset>
...
<!-- //products -->
 ...
 <!--//end-bottom-->
	...
	<ul class="socials">
	 ...
	 <div class="copy">
		<div class="container">
<p>&copy; 2019 All Rights Reserved </p>		</div>
	</div>
	 <!--//end-copyright-->
	<!--end-footer-->
 <!--//end-content-->
