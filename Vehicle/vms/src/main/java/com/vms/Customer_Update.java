...
public class Customer_Update extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			String Str="UPDATE Customer SET customer_name='"+customerName+"',customer_job='"+customerJob+"',customer_email="
					+ "'"+customerEmail+"',customer_gender='"+gender+"',customer_address='"+customerAddress+"' WHERE customer_id='"+customerId+"'";
